...
! function(t) {
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = E, e.removeAt = h, e.replaceAt = _, e.getIn = g, e.set = I, e.setIn = T, e.update = y, e.updateIn = m, e.merge = O, e.mergeDeep = A, e.mergeIn = S, e.omit = b, e.addDefaults = R;
    /*!
     * Timm
     *
                                    ...
                                    a && t.forEach(function(t, i) {
                                        ...
                                        ! function(t) {
                                            var e = t.store,
                                                ...
                                                m = c.id;
                                            Y(h, a) && (m = z(n, m));
                                            var O = v.hasBoundaryNodes && i ? T.getClosestElement(i, R) : null;
    ...
    function yt(t) {
        var e = t.store,
            ...
            a = e.getState(),
            u = a.ixInstances,
            c = a.ixSession.hasBoundaryNodes && r ? T.getClosestElement(r, R) : null;
    ...
    n(103), n(27), n(105), n(28), n(106), n(259), n(260), n(261), n(262), n(267), n(268), t.exports = n(269)
}, function(t, e, n) {
    "use strict";
    var r = n(2);
        ...
        switch (i) {
            ...
            case T.STYLE_TEXT_COLOR:
                var A = n.config,
                    ...
                    w = A.aValue;
                return {
                    rValue: S, gValue: b, bValue: R, aValue: w
                };
            case T.STYLE_FILTER:
    ...
    function C(t) {
        ...
        var w, C, L, x = (0, p.default)(n, "action.config.affectedElements", {})[_ || m] || {},
            ...
            D = n && u(N(n.target));
        if (P ? (w = x.limitAffectedElements, C = D, L = u(x)) : C = L = u({
                id: _,
                selector: m,
                selectorGuids: O
            }), n && b) {
    ...
    e.ixSession = function() {
        ...
        switch (e.type) {
            ...
            case v:
                for (var S = e.payload, b = S.width, R = S.mediaQueries, w = R.length, N = null, C = 0; C < w; C++) {
                    var L = R[C],
                        x = L.key,
                        P = L.min,
                        D = L.max;
    ...
    var c, s, f, l = u(n(26)),
        ...
        It = (r = {}, (0, o.default)(r, R, ht()), (0, o.default)(r, w, _t()), (0, o.default)(r, b, ht()), (0, o.default)(r, S, _t()), (0, o.default)(r, x, ht(!1)), (0, o.default)(r, L, _t(!1)), (0, o.default)(r, N, ht()), (0, o.default)(r, C, _t()), (0, o.default)(r, B, {
            ...
            handler: function(t) {
                ...
                return O && (A > .95 || A < .05) && (A = Math.round(A)), (u !== Y || b || b !== a.elementHovered) && (A = f ? 1 - A : A, e.dispatch((0, h.parameterChanged)(S, A))), {
                    elementHovered: b,
                    clientX: v,
                    clientY: _,
                    pageX: I,
        ...
        }), (0, o.default)(r, M, gt), (0, o.default)(r, j, gt), (0, o.default)(r, D, (0, l.default)({}, ut, {
                ...
                ! function(e, n) {
                    ...
                    if (_) f.on("click", function(t) {
                        ...
                        E.on("click", function() {
                            ...
                            (r = i.target && i.target.files && i.target.files[0]) && (o.toggle(!1), s.toggle(!1), a.toggle(!0), h.text(r.name), R() || m(n), n.fileUploads[e].uploading = !0, function(e, n) {
                                var r = {
                                    name: e.name,
                                    size: e.size
                                };
                    ...
                    function A(t) {
                        var r = t.responseJSON && t.responseJSON.msg,
                            i = T;
                        "string" == typeof r && 0 === r.indexOf("InvalidFileTypeError") ? i = I : "string" == typeof r && 0 === r.indexOf("MaxFileSizeError") && (i = g), p.text(i), f.removeAttr("data-value"), f.val(""), a.toggle(!1), o.toggle(!0), s.toggle(!0), n.fileUploads[e].uploading = !1, R() || y(n)
                    }
                    ...
                    function b(t) {
                        if (t) return A(t);
                        a.toggle(!1), u.css("display", "inline-block"), n.fileUploads[e].uploading = !1, R() || y(n)
                    }
    ...
    r.define("slider", t.exports = function(t, e) {
        ...
        function g(e, n) {
            ...
            i.el.off(d), i.left.off(d), i.right.off(d), i.nav.off(d), I(i), o ? (i.el.on("setting" + d, A(i)), O(i), i.hasTimer = !1) : (i.el.on("swipe" + d, A(i)), i.left.on("tap" + d, y(i)), i.right.on("tap" + d, m(i)), i.config.autoplay && !i.hasTimer && (i.hasTimer = !0, i.timerCount = 1, function t(e) {
                O(e);
                var n = e.config;
                var r = n.timerMax;
        ...
        function A(n) {
            return function(i, a) {
                ...
                if (o && "setting" === i.type) {
                    ...
                    ! function(n, r) {
                        var i = null;
                        r === n.slides.length && (E(), R(n)), e.each(n.anchors, function(e, n) {
